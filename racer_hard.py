...
backgroud = pygame.image.load(r"C:\Users\diffi\OneDrive\Рабочий стол\pp2\AnimatedStreet.png")
player_img = pygame.image.load(r"C:\Users\diffi\OneDrive\Рабочий стол\pp2\Player.png")
enemy_img = pygame.image.load(r"C:\Users\diffi\OneDrive\Рабочий стол\pp2\Enemy.png")
coin_img = pygame.image.load(r"C:\Users\diffi\OneDrive\Рабочий стол\pp2\\coin.png")
coin_img = pygame.transform.scale(coin_img, (55, 55))
backgroud_music = pygame.mixer.music.load(r"C:\Users\diffi\OneDrive\Рабочий стол\pp2\background.wav")
crash_sound = pygame.mixer.Sound(r"C:\Users\diffi\OneDrive\Рабочий стол\pp2\crash.wav")
